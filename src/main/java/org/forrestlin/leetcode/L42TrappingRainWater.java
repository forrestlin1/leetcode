...
public class L42TrappingRainWater {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(test.trap_bd(new int[]{4, 3, 1, 2}));
    }

    /**
     * 遍历数组，每一格能乘的水量等于左边最高位和右边最高位中，较低的那个，减去当前格的高度 使用优先队列，能保存右边最高位
     */
    ...
    /**
     * 双指针法 假设一开始left-1大于right+1，则之后right会一直向左移动，直到right+1大于left-1。在这段时间内right所遍历的所有点都是左侧最高点maxleft大于右侧最高点maxright的，
